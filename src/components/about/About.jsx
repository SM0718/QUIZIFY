...
function About() {
  return (
    <div className="w-full h-auto bg-[#5228f5] font-['Inter'] flex flex-col gap-10 text-center justify-evenly my-10">
        ...
        <p className='text-white m-0 text-xl flex flex-row justify-center gap-10'>
        ...
        <p className='text-white m-0 text-4xl flex flex-row justify-center gap-10'>Do Follow Me On My Socials Below</p>
